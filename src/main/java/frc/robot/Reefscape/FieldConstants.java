...
public class FieldConstants {
    ...
    public static final double[] branchHeightMeters = {0, // The lowest level on the reef is called L1 in the manual (as opposed to L0), so we have a dummy value at index 0 so that our indicies can match the nomenclature. Hopefully this helps prevent some off-by-one errors.
                                                       Units.inchesToMeters(17.88), // Highest point of L1 (not technically a branch, I know...)
    ...
    /** The angle that each branch level makes with the floor (all positive) */
    ...
    public static final double branchDiameterMeters = Units.inchesToMeters(1.66);
